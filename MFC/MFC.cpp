...
public:
	...
	afx_msg void OnCrudNoklistazasa();
};
...
BEGIN_MESSAGE_MAP(CAboutDlg, CDialogEx)
	ON_BN_CLICKED(IDC_BUTTON4, &CAboutDlg::Prev)
	ON_BN_CLICKED(IDC_BUTTON3, &CAboutDlg::Next)
	ON_COMMAND(ID_CRUD_FERFIAKLISTAZASA, &CAboutDlg::OnCrudFerfiaklistazasa)
	ON_COMMAND(ID_CRUD_NOKLISTAZASA, &CAboutDlg::OnCrudNoklistazasa)
END_MESSAGE_MAP()
...
void CAboutDlg::OnCrudFerfiaklistazasa()
{
	// TODO: Add your command handler code here
}


void CAboutDlg::OnCrudNoklistazasa()
{
	// TODO: Add your command handler code here
}
